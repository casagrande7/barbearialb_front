                                    ...
                                    {usuarios.map(usuario => (
                                        <tr key={usuario.id}>
                                            ...
                                            <td className='col-3'>
                                                ...
                                                <button onClick={() => recuperarSenha(usuario.id)} className='btn p-2 btn-dark btn-sm'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16">
